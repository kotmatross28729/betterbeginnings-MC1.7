...
public class StackRecipeElement extends RecipeElement
{
	...
	{
        if(BBConfig.noFoodRecipesNBTCheck && !BBConfig.noAllRecipesNBTCheck) {
            if (AppleCoreAPI.accessor.isFood(stackGiven)) {
                return stack.getItem() == stackGiven.getItem() && (stack.getItemDamage() == stackGiven.getItemDamage() || stack.getItemDamage() == OreDictionary.WILDCARD_VALUE);
            } else {
        ...
        } else if(BBConfig.noAllRecipesNBTCheck) {
            return stack.getItem() == stackGiven.getItem() && (stack.getItemDamage() == stackGiven.getItemDamage() || stack.getItemDamage() == OreDictionary.WILDCARD_VALUE);
        } else {
            return stack.getItem() == stackGiven.getItem() && (stack.getItemDamage() == stackGiven.getItemDamage() || stack.getItemDamage() == OreDictionary.WILDCARD_VALUE) && ItemStack.areItemStackTagsEqual(stack, stackGiven);
        }
	...
	{
        if(BBConfig.noFoodRecipesNBTCheckWithSize && !BBConfig.noAllRecipesNBTCheckWithSize) {
            if (AppleCoreAPI.accessor.isFood(stackGiven)) {
                return stack.getItem() == stackGiven.getItem() && (stack.getItemDamage() == stackGiven.getItemDamage() || stack.getItemDamage() == OreDictionary.WILDCARD_VALUE) && stack.stackSize <= stackGiven.stackSize;
            } else {
        ...
        } else if(BBConfig.noAllRecipesNBTCheckWithSize) {
            return stack.getItem() == stackGiven.getItem() && (stack.getItemDamage() == stackGiven.getItemDamage() || stack.getItemDamage() == OreDictionary.WILDCARD_VALUE) && stack.stackSize <= stackGiven.stackSize;
        } else {
            return stack.getItem() == stackGiven.getItem() && (stack.getItemDamage() == stackGiven.getItemDamage() || stack.getItemDamage() == OreDictionary.WILDCARD_VALUE) && ItemStack.areItemStackTagsEqual(stack, stackGiven) && stack.stackSize <= stackGiven.stackSize;
        }
